...
CREATE TABLE league_items_rolling (
    ...
    mean        DECIMAL(10,8)  UNSIGNED NOT NULL DEFAULT 0.0,
    median      DECIMAL(10,8)  UNSIGNED NOT NULL DEFAULT 0.0,
    mode        DECIMAL(10,8)  UNSIGNED NOT NULL DEFAULT 0.0,
    exalted     DECIMAL(10,8)  UNSIGNED NOT NULL DEFAULT 0.0,
...
CREATE TABLE league_entries (
    ...
    price      DECIMAL(10,8)  UNSIGNED NOT NULL,
...
CREATE TABLE league_history_daily_inactive (
    ...
    mean      DECIMAL(10,8)  UNSIGNED DEFAULT NULL,
    median    DECIMAL(10,8)  UNSIGNED DEFAULT NULL,
    mode      DECIMAL(10,8)  UNSIGNED DEFAULT NULL,
    exalted   DECIMAL(10,8)  UNSIGNED DEFAULT NULL,
