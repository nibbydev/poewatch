package watch.poe.manager.league;
...
import watch.poe.manager.league.derserializer.BaseLeague;
import watch.poe.manager.league.derserializer.Rule;
...
public class LeagueManager {
    ...
    public boolean cycle() {
        ...
        if (success) {
            ...
            Main.DATABASE.updateLeagues(sortedLeagues);
        }
