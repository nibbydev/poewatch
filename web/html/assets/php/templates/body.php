...
<?php global $PAGEDATA; foreach($PAGEDATA["priceCategories"] as $category): ?>
            <a class="col-12 d-flex align-items-center p-1 pw-hover-light <?php if (isset($_GET["category"]) && $_GET["category"] === $category['name']) echo "pw-highlight " ?>rounded" href="<?php echo $category["href"] ?>" title="<?php echo $category["display"] ?>">
