<?php 
  ...
  $PAGEDATA["title"] = "Item - PoeWatch";
  $PAGEDATA["description"] = "Detailed price history from past leagues for a specific item";
  $PAGEDATA["cssIncludes"][] = "prices.css";
  $PAGEDATA["jsIncludes"][] = "item.js";
                ...
                <table class="table table-sm details-table table-striped table-hover mw-item-dTable">
                  <tbody>
                    <tr>
                      ...
                      <td class='nowrap'>
                        <span id='details-table-total'></span>
                      </td>
                    </tr>
                    <tr>
            ...
            <div class='row m-1 mb-3'>
              <div class='col-sm'>
                <div class="btn-group btn-group-toggle mt-1 mb-3" data-toggle="buttons" id="history-dataset-radio">
                  ...
                  <label class="btn btn-sm btn-outline-dark p-0 px-1 <?php if ( isset($_GET['dataset']) && $_GET['dataset'] ===  'daily') echo 'active' ?>"><input type="radio" name="dataset" value='daily'  <?php if ( isset($_GET['dataset']) && $_GET['dataset'] ===  'daily') echo 'checked' ?>>Daily</label>
                </div>
