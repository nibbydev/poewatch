        ...
        <div class='body-boundaries w-100'> 
          <div class="card custom-card">
            ...
            <div class="card-body pagination-page" id='page-faq'>
              ...
              <p>What do the 'change' and 'count' columns mean?<br><span class='custom-text-gray'>Change refers to how much the price has changed when comparing the price right now and 7 days ago. Count means how many of that item is listed every 24 hours.</span></p>
              <p>The currency page is cluttered with too many different items.<br><span class='custom-text-gray'>Use the Group search option to filter based on Currency, Essences and other groups.</span></p>
              ...
              <p>Why doesn't a character from X league show up in the characters page?<br><span class='custom-text-gray'>Only users who have listed something on sale using public stash tabs have that specific character recorded.</span></p>
              <p>Is this site somehow related to poe.ninja?<br><span class='custom-text-gray'>No, although it was inspired by it.</span></p>
              <p>What's the benefit of using this over poe.ninja?<br><span class='custom-text-gray'>Additional features such as the ability to view prices from past leagues, see the quantities of items being listed each day, character search, linking specific items, saving searches, and a sleek UI.</span></p>
              <p>Item X has an incredibly high price at league start. Why?<br><span class='custom-text-gray'>Quite often the first person to find a particular item during a new league will list it for much more than it's actually worth.</span></p>
